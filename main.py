...
import time 
start = time.time()
from cv2 import fastNlMeansDenoisingColored,VideoCapture, CAP_PROP_FRAME_HEIGHT, CAP_PROP_FRAME_WIDTH, CAP_PROP_FPS, cvtColor, COLOR_BGR2GRAY, createCLAHE, COLOR_BGR2RGB, COLOR_RGB2BGR
...
█▄▄ █▀█ █░▀░█ ██▄ █▀▄ █▀█   █ ▄█   █▀▄ █▄█ █░▀█ █░▀█ █ █░▀█ █▄█'''
        ...
        while True:
            ...
            if results.multi_face_landmarks:
                ...
                image_crop = fastNlMeansDenoisingColored(image_crop, None, 10, 10, 1, 2)
            else:
                image_crop = image[int(start_y):int(stop_y), int(start_x):int(stop_x), :]
